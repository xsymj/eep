...
//			email.addCc("loyin@loyin.net");// 密抄
	...
	public void sendEmail2() {
		try {
			MailSenderInfo mailInfo=new MailSenderInfo();
			Properties props=mailInfo.getSSLProperties();
			Session session = Session.getDefaultInstance(props, new Authenticator(){  
			      protected PasswordAuthentication getPasswordAuthentication() {  
			          return new PasswordAuthentication("313550520", "qnjlvndqiuknbgeb");  
			  ...
			  msg.setFrom(new InternetAddress("313550520" + "@qq.com"));  
			  msg.setRecipients(Message.RecipientType.TO,   
			  InternetAddress.parse("zyk427@126.com",false));  
