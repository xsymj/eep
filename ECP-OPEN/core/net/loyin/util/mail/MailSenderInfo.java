...
public class MailSenderInfo {
	...
	public String mailSSLServerPort = PropertiesContent.get("mail.ssl.smtp.port");
	/** 邮件发送者的地址 */
	...
	public Properties getSSLProperties() {
		  ...
		  props.setProperty("mail.smtp.port", this.mailSSLServerPort);  
		  props.setProperty("mail.smtp.socketFactory.port", this.mailSSLServerPort);  
	...
	public boolean sendMail() {
		return this.sms.sendHtmlMail(this);
	}
