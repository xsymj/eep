...
var model = avalon.define({$id:'view',user:SYSTEM.user,
    query :{start_date:SYSTEM.beginDate,end_date:SYSTEM.endDate,depot_id:'',product_id:'',product_name:'',head_id:"",head_name:"",type_id:""},
    list:[],amount_in_total:0,amount_out_total:0,nprint:true,depotList:[],typeList:[],
	...
	init:function(){
		...
		var typeList1 =  '[{"name":"采购入库","id":0},{"name":"销售退货入库","id":1},{"name":"调拨入库","id":2},{"name":"其它入库","id":3},{"name":"销售出库","id":4},{"name":"采购退货出库","id":5},{"name":"调拨出库","id":6},{"name":"其它出库","id":7}]';
		model.typeList = JSON.parse(typeList1);
//		model.loadData();
	},
	loadData:function(){
