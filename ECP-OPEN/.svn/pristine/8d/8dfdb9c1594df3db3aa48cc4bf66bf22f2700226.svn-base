...
billType=['采购入库','材料退料入库','材料调拨出库','领用出库','销售出库','采购退货出库','材料销售退料','其它出库'];
var model = avalon.define({$id:'view',
	query:{keyword:"",start_date:SYSTEM.beginDate,end_date:SYSTEM.endDate,type:"",is_deleted:0,qryType:5,status:""},
	...
	loadGrid:function() {
		...
		$("#grid").jqGrid({
			...
			colModel:[ {
				...
				align:"center",formatter:function(v){return v==''?'系统':v;},
				width:100,
				title:false
			}, {
