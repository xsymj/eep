...
Public.comboTreeb=function($obj,opts){
    var i = $("<div class='comboDiv'/>");
    var aa = $("#category_m").val();
    alert('b');
    console.log('yes' +JSON.stringify(aa));
...
Public.comboTreea=function($obj,opts){
	var i = $("<div class='comboDiv'/>");
	i.appendTo($obj.parent());
	i.hide();
	i.offtop=$obj.offtop+50;
...
/*$(".manage-wrapper").bind("click",function(e){
	console.log(e.target.className)
	if(e.target.className=='ui-input'||e.target.className=='comboDiv'||e.target.className=='tx'){
		console.log($(this).siblings(".comboDiv"))
		$(this).siblings(".comboDiv").show();
	}
	else{
		$(this).siblings(".comboDiv").hide();
	}
})
*/
