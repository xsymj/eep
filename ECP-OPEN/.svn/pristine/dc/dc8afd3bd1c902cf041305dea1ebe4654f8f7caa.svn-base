...
custParame=SYSTEM.custParame,typeList=custParame.typeList,url=rootPath+"/crm/custService";
var model = avalon.define({$id:'view',
	data:{name:"",sex:1,telephone:"",is_main:1,post:"",department:"",saltname:"",telephone:"",idcard:"",qq:"",email:"",address:"",zip_code:"",contacts_id:"",description:"",id:"",customer_id:"",customer_name:"",product:"",custType:1},
    ...
    qryCustomer:function(v){//自动完成查询客户
    	...
    	Public.ajaxPost(rootPath+"/crm/custService/dataGrid.json",{keyword:v},function(json){
