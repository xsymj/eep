var model = avalon.define({$id:'view',expoutUrl:""});
var queryConditions = {
	keyword : "",category:''
		...
		$("#grid").jqGrid({
			...
			},
            {
                ...
                formatter:function(v,e,r){
                	console.log(v);
                    console.log(parent.SYSTEM.custParame);
                    var id= v;
                    if(id)
                        return parent.SYSTEM.custParame[id].name;
                    else
                        return "";
				},
                ...
                formatter:function(v,e,r){
                    ...
                    var id=v;
                    if(id){
                    	console.log(parent.SYSTEM.custParame[id]);
                    	if(parent.SYSTEM.custParame[id].name){
                    		return parent.SYSTEM.custParame[id].name;
                    	} else {
                    		return "";
                    	}
