...
public class Customer extends Model<Customer> {
	...
	public Page<Customer> pageGrid(int pageNo, int pageSize,Map<String, Object> filter,Integer qryType) {
		...
		sql.append(" con on t.id=con.customer_id left join ");
		sql.append(userView);
		...
		return dao.paginate(pageNo, pageSize, "select t.*,h.realname as head_name,c.realname as creator_name,u.realname as updater_name,con.name contacts_name,con.telephone contacts_phone  ",sql.toString(),parame.toArray());
	}
	/**
	 * 查询客户信息及联系人信息
	 * @param filter
