...
public class Product extends Model<Product> {
	...
	public Page<Product> pageGrid(Integer pageNo,Integer pageSize,Map<String,Object> filter){
		...
		return dao.paginate(pageNo,pageSize,"select t.id,t.update_time,t.id product_id,t.name,t.name product_name,t.category_type,t.unit,t.stock_warn,t.billsn,t.status,t.model,t.sale_price,t.purchase_price,t.category,t.category_m,t.brand,t.spec,t.weight,t.moq,t.cycle,t.expired,t.expiredremind,t.packunit,t.packformat,t.lwh,t.sellpoint,t.imgurl",
	...
	public void insert(Map<String, Object> params,String company_id){
		...
		Db.update("insert into "+tableName+"(id,company_id,billsn,name,category,category_m,brand,model,packformat,"
				+ "purchase_price,sale_price,unit,cycle,expired,expiredremind,packunit,spec,rate,moq,len,kuan,heigh,chird_brand,customer_id,sellpoint,remark,status,category_type) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", 
				...
				params.get("min_num"),params.get("length"),params.get("kuan"),params.get("height"),params.get("chirdBrand"),"L0k9",params.get("maidian"),params.get("pizhu"),1,params.get("category_type"));
	}
